...
* <2020-06-12 Fri> linux no gui
  #+BEGIN_EXAMPLE
  iPlug2/IPlug/VST3/IPlugVST3_RunLoop.h:22:10: fatal error: xcbt.h: No such file or directory
  #+END_EXAMPLE

  https://github.com/surge-synthesizer/surge/issues/19
  #+BEGIN_EXAMPLE
  /usr/bin/ld: IPlugMinimal-VST3@sha/subprojects_iPlug2_Dependencies_IPlug_VST3_SDK_base_source_timer.cpp.o: in function `Steinberg::SystemTime::ZeroStartTicks::getTicks32()':
/home/actondev/dev/actondev/meson-iPlug2/examples/IPlugMinimal/build-multiple/../subprojects/iPlug2/Dependencies/IPlug/VST3_SDK/base/source/timer.cpp:66: undefined reference to `Steinberg::SystemTime::getTicks64()'
  #+END_EXAMPLE
** <2020-06-13 Sat> SDL window
   useful files
   - ../iPlug2/IPlug/IPlugEditorDelegate.h
     #+BEGIN_SRC c
...
// iPlug2/WDL/swell/swell-generic-headless.cpp
